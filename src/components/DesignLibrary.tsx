  ...
  return (
    <main className="libraryPage">
      ...
      <section className="hero">
        <div><p className="eyebrow">Open-source, AI-native creative studio</p><div className="headingRow"><h1>Create ads, designs, images, and video with people and agents.</h1><HelpDialog title="How MakeTrailer works"><p>Your projects, designs, and reusable assets stay in a local folder on this computer. There is no account or cloud database.</p><p>Choose a project and starting layout, edit the layers, then export a PNG. Add your own fal.ai key to generate images. Connect the local MCP server to let an AI client work in the same projects.</p></HelpDialog></div><p className="heroCopy">Create in {activeProject?.name || "your local project"}, reuse its assets, and hand the same workspace to any MCP-capable agent.</p></div>
